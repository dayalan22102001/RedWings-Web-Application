                    ...
                    <div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-lg-auto">
                            ...
                            <li class="nav-item mx-lg-4 my-lg-0 my-3">
                                <a class="nav-link" href="search-donor.php">Need a Donor</a>
                            </li>
                            <li class="nav-item mx-lg-4 my-lg-0 my-3">
                                <a class="nav-link" href="web\index.html" target="_blank" >Blood Banks</a>
                            </li>
                            <!-- <li class="nav-item mx-lg-4 my-lg-0 my-3">
                            ...
                            <li class="nav-item mx-lg-4 my-lg-0 my-3">
                                <a class="nav-link" href="about.php">About Us and Our App</a>
                            </li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <!-- <a class="dropdown-item" target = "_blank" href="chat\index.php">Red Wings Chat</a>
                                    <div class="dropdown-divider"></div> -->
                                    <a class="dropdown-item" target = "_blank" href="chatapp\index.php">Red Wings Chat</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="change-password.php">Change Password</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="request-received.php">Request Received</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="donor-status.php">Update Donor Status</a>
                                    <div class="dropdown-divider"></div>
