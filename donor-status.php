	...
	<div class="agileits-contact py-5">
		<div class="py-xl-5 py-lg-3">
			<div class="w3ls-titles text-center mb-5">
				<h3 class="title">Update Your Donor Status</h3>
				<span>
				...
				<div class="col-lg-7 contact-right-w3l">
					...
					<form action="#" method="post">
						...
						<div class="form-group">
                            ...
                            placeholder="Type 'Blood Donotion Successfull by 'your_donor_name'' if not please mention the donor details and your problem." maxlength="999" style="resize:none"></textarea>
						</div>
						<div class="form-group">
