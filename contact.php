	...
	<div class="agileits-contact py-5">
		<div class="py-xl-5 py-lg-3">
			<div class="w3ls-titles text-center mb-5">
				...
				<p class="mt-2">Fill the following information with appropriate details and please brief your queries in the 'Message/Description' box</p>
			</div>
			<div class="d-flex">
				<div class="col-lg-5 w3_agileits-contact-left">
				</div>
				<div class="col-lg-7 contact-right-w3l">
					<h5 class="title-w3 text-center mb-5">ENTER THE FOLLOWING DETAILS</h5>
					<form action="#" method="post">
						...
						<div class="form-group">
							<textarea rows="10" cols="100" class="form-control" id="message" name="message" placeholder="Message/Description" maxlength="999" style="resize:none"></textarea>
						</div>
						<div class="form-group">
