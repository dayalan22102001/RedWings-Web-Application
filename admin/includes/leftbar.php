...
<li><a href="manage-bloodgroup.php">Manage Blood Group</a></li>
			...
			<li><a href="request-received-bydonar.php"><i class="fa fa-users"></i> Request Received By Each Donar</a></li>
			<li><a href="total-requests.php"><i class="fa fa-users"></i>Total Requests</a></li>
