...
// $search = $_POST['search'];
// 		$stmt = $con->prepare("	SELECT * from tblblooddonars where MobileNumber like '%$search%' or name like '%$search%'");
// 		$stmt->execute();
...
<a href="donor-list.php?public=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Active this detail')" class="btn btn-primary"> Make it Active</a>
